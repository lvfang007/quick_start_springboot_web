...
public class MabatisPlusGenerator {
    ...
    //基本包名
    private static String basePackage="com.autohome.outerapi";
    //作者
    private static String authorName="lvfang";
    //要生成的表名
    private static String[] tables= {"db_phone","db_phone_type"};
    //table前缀
    private static String prefix="db_";
